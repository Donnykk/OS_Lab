...
readseg(uintptr_t va, uint32_t count, uint32_t offset) {
    ...
    7c84:	f7 35 ec 7d 00 00    	divl   0x7dec
...
outb(uint16_t port, uint8_t data) {
    ...
    7ced:	8b 0d ec 7d 00 00    	mov    0x7dec,%ecx
    asm volatile (
    ...
    for (; va < end_va; va += SECTSIZE, secno ++) {
    7d00:	03 1d ec 7d 00 00    	add    0x7dec,%ebx
    7d06:	46                   	inc    %esi
...
bootmain(void) {
    ...
    7d10:	a1 ec 7d 00 00       	mov    0x7dec,%eax
    7d15:	31 c9                	xor    %ecx,%ecx
    7d17:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    7d1e:	a1 e8 7d 00 00       	mov    0x7de8,%eax
bootmain(void) {
    ...
    7d2c:	a1 e8 7d 00 00       	mov    0x7de8,%eax
    ...
    7d39:	8b 58 1c             	mov    0x1c(%eax),%ebx
    eph = ph + ELFHDR->e_phnum;
    7d3c:	0f b7 70 2c          	movzwl 0x2c(%eax),%esi
    ph = (struct proghdr *)((uintptr_t)ELFHDR + ELFHDR->e_phoff);
    ...
    7d63:	a1 e8 7d 00 00       	mov    0x7de8,%eax
